...
Estudante de Ciência da Computação (7º semestre, UniSinos) com foco em Python, ciência de dados e desenvolvimento backend. Construindo soluções que conectam análise e modelagem de dados à exposição via APIs.
